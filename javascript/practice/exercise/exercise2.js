...
// ]
// const infofilter = info.filter(function(user) {
//     console.log(user)
    
//     return user.name == "ersin"
    
    
// })

// infofilter.forEach(function(user) {
...
//     //change username letters to upper case
...
// function PrinterService(getFilteredData){
//     const getResult = FilterData(getFilteredData)
//     console.log(getResult)
// }
// PrinterService(users)

// var numbers = [1, 90, 3, 4, 35, 6, 7, 81, 9, 10];
...
// result=[nestedArray[0],nestedArray[1], nestedArray[2]]
